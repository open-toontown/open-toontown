...
GlobalStreetNames = {20000: ('to', 'on', 'the dumb place'),
...
QuestDialogDict = {160: {GREETING: '',
 ...
 175: {GREETING: '',
       QUEST: "Congratulations on completing your first battle!\x07Now let me tell you about some helpful singleplayer features.\x07In your Shticker Book, you can INSTANTLY RESTOCK all your gags for free - just click the Restock All button!\x07During battles, use the green Toon-Up button to heal yourself.\x07Also, you have your very own Toon house! Clarabelle Cow runs a phone catalog where you can order furniture.\x07I'll tell Clarabelle to send you your first catalog now.\x07Go to your home and use your phone to call Clarabelle.",
       INCOMPLETE_PROGRESS: 'Go home and use your phone to call Clarabelle. Remember: Open your Shticker Book anytime to restock gags!',
       COMPLETE: 'Excellent! You now know the basics of Toontown!\x07Remember: Cogs in each area have reduced HP for solo play.\x07You can restock gags anytime in your Shticker Book.\x07Use Toon-Up gags in battle to heal yourself.\x07Keep doing ToonTasks to get more rewards and unlock new gag tracks!\x07Have fun saving Toontown!',
       LEAVING: QuestsDefaultLeaving},
 400: {GREETING: '',
       QUEST: 'Throw and Squirt are great, but you will need more gags to fight higher level Cogs.\x07In singleplayer mode, choosing the right gags is crucial for survival!\x07Try different combinations of gags to see what works best.\x07For your next track, choose between Sound and Toon-Up.\x07Sound is special because when it hits, it damages all Cogs at once - perfect for solo play!\x07Toon-Up lets you heal yourself in battle - very useful when playing alone!\x07Both are excellent choices for singleplayer. When you are ready to decide, come back here and choose.',
...
FADoorCodes_TALK_TO_TOM = 'aint no way you going out'
FADoorCodes_DEFEAT_FLUNKY_HQ = 'sorry but theres no becoming a cog bud'
FADoorCodes_TALK_TO_HQ = 'broooo why u skipping the most important thing'
FADoorCodes_WRONG_DOOR_HQ = 'LOL WHERE YOU GOING'
FADoorCodes_GO_TO_PLAYGROUND = 'i cant believe the game wont let you stay in this dumb place like bruh'
FADoorCodes_DEFEAT_FLUNKY_TOM = 'RUN AWAY FROM THE FLUNKY'
FADoorCodes_TALK_TO_HQ_TOM = 'no sticker book?'
FADoorCodes_SUIT_APPROACHING = None
FADoorCodes_BUILDING_TAKEOVER = "GET OOOOUUT"
...
InventoryPass = 'PASS'
InventoryFire = 'FIRE'
InventoryClickToAttack = 'Click a gag to attack!\n\nBATTLE BASICS:\n- Throw gags (pies) deal damage\n- Squirt gags (water) deal damage\n- Toon-Up gags (green) heal you!\n- Use stronger gags for more damage!'
...
ToonSleepString = '. . . ZZZ . . .'
MovieTutorialReward1 = 'Wowza! Look at you go! *confetti explosion* You just completed your first battle! That\'s AMAZING progress!'
MovieTutorialReward2 = 'And guess what? You earned some experience points too! *trumpet fanfare* Your gags are getting stronger with every battle!'
MovieTutorialReward3 = 'HOLY MOLY! You won your first battle! *does victory dance* You\'re officially a Toon warrior now!'
MovieTutorialReward4 = 'Here, take this ToonTask reward! *hands over item* Take it to Toon HQ and show %s - he\'ll be so proud!' % Flippy
MovieTutorialReward5 = 'Alright, time to head to Toon HQ! *points excitedly* Go see %s and get your next adventure started!' % Flippy
...
FishPokerPair = 'Pair'
TutorialGreeting1 = "Well, well, well! Look who just rolled into Toontown! *adjusts imaginary tie* Welcome, newcomer! What's your name, friend?"
TutorialGreeting2 = 'Your name is %s? Ooh, I like it! That\'s a name that screams "hero material"! Nice to meet you!'
TutorialGreeting3 = 'Welcome to Toontown! Come on over here - I\'ve got SO much to show you! This place is wild!'
TutorialMickeyWelcome = 'Welcome to Toontown, %s! *does a little dance* You\'re gonna love it here!'
TutorialFlippyIntro = 'Hey! Let me introduce you to my buddy %s! He\'s the big cheese around here - runs Toon HQ like a pro!' % Flippy
TutorialFlippyHi = 'Well hello there, %s! *tips hat* Great to meet you! Welcome to the team!'
TutorialQT1 = 'See this chatty little button down here? That\'s your ticket to talking!'
TutorialQT2 = 'Go ahead and click that chat button, then pick "Hi" from the menu. Give it a try!'
TutorialChat1 = 'Alrighty! You\'ve got TWO ways to chat - pick your favorite!'
TutorialChat2 = 'The blue button? That\'s your keyboard chat - type whatever you want! Perfect for when you\'ve got something specific to say!'
TutorialChat3 = "Just so you know - in this singleplayer version, you won't see other players running around, but the chat system still works perfectly for talking to NPCs!"
TutorialChat4 = 'The green button opens up the %s - it\'s like a menu of pre-made phrases!'
TutorialChat5 = 'The %s is SUPER handy for quick communication! No typing required - just point and click!'
TutorialChat6 = 'Go ahead and try saying "Hi" using the SpeedChat! Click the green button and find "Hi" in there!'
TutorialBodyClick1 = 'Perfect! You\'re getting the hang of this! *cheers*'
TutorialBodyClick2 = 'Pleased to meet you too! Hey, want to be friends? Friends are great - they help you out and stuff!'
TutorialBodyClick3 = 'To make friends with %s, just click right on him... go ahead, give him a friendly click!' % Flippy
TutorialHandleBodyClickSuccess = 'Excellent work! You\'re a natural at this!'
TutorialHandleBodyClickFail = 'Almost there! Try clicking directly on %s - aim for his body!' % Flippy
TutorialFriendsButton = "Now look up at the top right corner - see %s's picture? Click that 'Friends' button right under it!" % Flippy
TutorialHandleFriendsButton = "Great! Now click the 'Yes' button to confirm you want to be friends!"
TutorialOK = lOK
TutorialYes = lYes
TutorialNo = lNo
TutorialFriendsPrompt = 'Would you like to make friends with %s? Friends are awesome - you can visit each other and go on adventures together!' % Flippy
TutorialFriendsPanelMickeyChat = "%s has agreed to be your friend! *confetti* Click 'Ok' to finish up and celebrate!" % Flippy
TutorialFriendsPanelYes = '%s said yes! *happy dance* You\'ve got a new friend!' % Flippy
TutorialFriendsPanelNo = "Hmm, that's not very friendly! Try clicking 'Yes' instead - friends are great!"
TutorialFriendsPanelCongrats = 'Congratulations! *trumpet fanfare* You made your first friend! This is just the beginning!'
TutorialFlippyChat1 = 'Come see me when you\'re ready for your first ToonTask! I\'ll have something exciting for you!'
TutorialFlippyChat2 = "I'll be waiting in Toon Hall - you can't miss it! It's the big building with all the flags!"
TutorialAllFriendsButton = 'Want to see all your friends? Just click that friends button anytime! Go ahead, try it out!'
TutorialEmptyFriendsList = "Right now your list is pretty empty because %s isn't a real player. But in singleplayer mode, NPCs can totally be your friends - and they're pretty cool too!" % Flippy
TutorialCloseFriendsList = "All done looking? Click the 'Close'\nbutton to make the\nlist disappear!"
TutorialShtickerButton = 'See that button in the lower right corner? That\'s your Shticker Book - it\'s like your personal guide to everything! Click it!'
TutorialBook1 = 'This book is PACKED with useful stuff! Check it out - there\'s a map of Toontown, your quests, your gags... it\'s got everything!'
TutorialBook2 = 'You can check your ToonTask progress, see what gags you have, and even plan your next adventure! It\'s your command center!'
TutorialBook3 = 'When you\'re done exploring, just click the book button again to close it. Easy peasy!'
TutorialLaffMeter1 = "Okay, listen up - this is SUPER important! *leans in dramatically*"
TutorialLaffMeter2 = "See that colorful bar at the top? That's your Laff meter - it shows how much health you have! When it's full, you're happy and healthy!"
TutorialLaffMeter3 = 'When those mean ' + Cogs + ' attack you in battle, your Laff goes down. Keep an eye on it - if it hits zero, you\'ll be sad!'
TutorialLaffMeter4 = 'The good news? When you\'re in safe playgrounds like this one, your Laff slowly recovers over time. Just relax and let it heal!'
TutorialLaffMeter5 = 'In singleplayer mode, Cogs are balanced just for you! They have less health based on the area you\'re in, so battles are fair and fun!'
TutorialLaffMeter6 = 'BATTLE SECRET: During battles, use Toon-Up gags (the green ones!) to heal yourself! You can also restock your gags anytime by opening your Shticker Book!'
TutorialLaffMeter7 = "If you get defeated, don't panic! You'll respawn right here in the playground, and you can restock all your gags for FREE. It's like a second chance!"
TutorialLaffMeter8 = 'Want more gags? Play trolley games to earn jellybeans, then visit Goofy\'s Gag Shop! The more gags you have, the stronger you become!'
TutorialGagShop1 = 'At Goofy\'s Gag Shop, you can buy all sorts of gags with jellybeans! From pies to pianos, we\'ve got everything you need to fight Cogs!'
TutorialGagShop2 = 'In singleplayer mode, gag shops also have a FREE instant restock button - super convenient when you\'re in a pinch!'
TutorialBattleTips1 = 'BATTLE TIP: Use the green Toon-Up button during battle to heal yourself! Keep your Laff high and you\'ll win every time!'
TutorialBattleTips2 = 'BATTLE TIP: Cogs in each playground have scaled HP for solo play - they\'re tough but fair!'
TutorialBattleTips3 = 'BATTLE TIP: Open your Shticker Book, go to the Gag page, and click "Restock All" to instantly refill your gags! No jellybeans needed!'
TutorialBattleMechanics1 = 'BATTLE MECHANICS EXPLAINED:\n\n1. GAG TRACKS: You have 7 types of gags!\n   - Throw: Pies and cakes (damage)\n   - Squirt: Water and hoses (damage)\n   - Toon-Up: Healing gags (heal yourself!)\n   - Sound: Music attacks (hits all Cogs!)\n   - Lure: Hypnotize Cogs (makes them skip turns)\n   - Trap: Explosive surprises (big damage!)\n   - Drop: Heavy objects (massive damage!)'
TutorialBattleMechanics2 = '2. GAG LEVELS: Each gag track has 7 levels!\n   - Level 1 = Weakest (but free!)\n   - Level 7 = Strongest (devastating!)\n   - Use gags in battle to level them up!\n   - Higher level = more damage/healing!'
TutorialBattleMechanics3 = '3. BATTLE STRATEGY:\n   - Attack Cogs to reduce their HP to zero\n   - Use Toon-Up when your Laff is low\n   - Sound attacks hit ALL Cogs at once!\n   - Lure makes Cogs skip their turn\n   - Trap + Lure combo = massive damage!'
TutorialBattleMechanics4 = '4. EXPERIENCE POINTS:\n   - Using gags in battle gives you EXP\n   - More EXP = stronger gags unlocked\n   - Defeating Cogs gives bonus EXP!\n   - Keep battling to unlock all 7 levels!'
TutorialProgress = 'Tutorial Progress: Step %d of %d'
TutorialStepWelcome = 'Welcome to Toontown! *confetti* I\'m Mickey, and I\'ll be your guide! Let\'s learn the basics together!'
TutorialStepChat = 'First, let\'s learn how to chat! Click the blue chat button at the bottom of your screen, then type "Hi"!'
TutorialStepFriends = 'Great! Now let\'s make a friend! Click on Flippy (the NPC), then click the Friends button!'
TutorialStepShticker = 'Perfect! Now open your Shticker Book - it\'s your guide to everything! Click the book button in the lower right!'
TutorialStepLaff = 'See that colorful bar at the top? That\'s your Laff meter - your health! Keep it full to stay happy!'
TutorialStepGagShop = 'Time to visit Goofy\'s Gag Shop! Walk through the door to buy gags with jellybeans!'
TutorialStepBattle = 'Ready for your first battle? Walk outside and find the Cog! I\'ll explain everything as we go!'
TutorialStepComplete = 'Congratulations! *trumpet fanfare* You\'ve completed the tutorial! Head to Toon HQ for your first ToonTask!'
TutorialBattleStep1 = 'BATTLE BASICS:\n\nThis is your gag inventory! Click a gag to select it, then click "Attack" to use it!'
TutorialBattleStep2 = 'GAG TYPES:\n\n- Throw gags (pies) deal damage\n- Squirt gags (water) deal damage\n- Toon-Up gags (green) heal you!'
TutorialBattleStep3 = 'BATTLE STRATEGY:\n\nReduce the Cog\'s HP to zero to defeat it! Watch your Laff meter - use Toon-Up if it gets low!'
TutorialBattleStep4 = 'EXPERIENCE:\n\nUsing gags gives you EXP! More EXP unlocks stronger gags! Keep battling to get stronger!'
TutorialBattleExplanation1 = 'BATTLE STARTED!\n\nWelcome to your first battle! Click a gag from your inventory to attack the Cog!'
TutorialBattleExplanation2 = 'GOOD CHOICE!\n\nYou selected a damage gag! Click "Attack" to use it and deal damage to the Cog!'
TutorialBattleExplanation3 = 'NICE ATTACK!\n\nYou dealt damage! The Cog\'s HP went down. Keep attacking until it reaches zero!'
TutorialBattleExplanation4 = 'COG ATTACK!\n\nThe Cog attacked you! Your Laff meter went down. Use Toon-Up gags to heal!'
TutorialBattleExplanation5 = 'HEALING!\n\nGreat job using Toon-Up! Your Laff meter is recovering. Keep your health high!'
TutorialBattleExplanation6 = 'COG DEFEATED!\n\nExcellent! You defeated the Cog! You earned experience points! Your gags are getting stronger!'
TutorialTrolley1 = 'Follow me to the trolley! *skips excitedly* It\'s time for some fun and games!'
TutorialTrolley2 = 'Hop on board and play some games! You\'ll earn jellybeans and have a blast!'
TutorialBye1 = 'Go play some games to earn jellybeans! The more you play, the more you earn!'
TutorialBye2 = 'Play some games to earn jellybeans!\nThen visit Goofy\'s Gag Shop to stock up!'
TutorialBye3 = 'When you\'re all done, go see %s at Toon Hall! He\'ll have your first ToonTask ready!' % Flippy
TutorialForceAcknowledgeMessage = 'Whoa there, partner! *waves arms* You\'re going the wrong way! Head back and find %s - he\'s got more to show you!' % Mickey
...
PromptTutorial = "CONGRATULATIONS!\n\nYou've created your Toon!\n\nWould you like to take the tutorial?\n\nIt's super helpful and teaches you everything about Toontown, including battle mechanics, gags, quests, and more!\n\n(You can always skip it if you're already familiar with the game!)"
MakeAToonSkipTutorial = 'Skip Tutorial'
MakeAToonEnterTutorial = 'Take Tutorial'
MakeAToonDone = 'Done'
...
QuestScriptTutorialMickey_1 = 'Well hello there! *tips hat* Welcome to Toontown! I\'m Mickey, and I\'m here to show you the ropes!'
QuestScriptTutorialMickey_2 = 'This place is AMAZING! We\'ve got playgrounds, battles, quests, gags, and so much more! But first, let\'s learn the basics!'
QuestScriptTutorialMickey_3 = 'Toontown is full of Cogs - those mean robots trying to take over! But don\'t worry - we Toons fight back with our gags and our laughter!'
QuestScriptTutorialMickey_4 = 'Ready to learn how to battle? Let\'s head outside and I\'ll show you how it\'s done! Follow me!'
QuestScriptTutorialMinnie_1 = 'i brought in your car keys tom'
QuestScriptTutorialMinnie_2 = 'oh thanks mlady'
QuestScriptTutorialMinnie_3 = 'whar?'
QuestScript101_1 = 'see these things?'
QuestScript101_2 = 'they are dumb.'
QuestScript101_3 = 'so anyways'
QuestScript101_4 = '*sobs* how you doing??? WAAAAHHHH!!!!'
QuestScript101_5 = "i'm actually feeling kinda hungery ngl"
QuestScript101_6 = 'heres my inventory'
QuestScript101_7 = 'and here.... is my picnic table'
QuestScript101_8 = 'also have this alien thingy'
QuestScript101_9 = "OH SHIT I DROPPED IT"
QuestScript101_10 = 'NOOOOOOOOOOOO'
QuestScript101_11 = "WHO IS THAT"
QuestScript101_12 = 'HELP ME, PLEASE!'
QuestScript101_13 = 'KILL IT KILL IT KILL ITTTTTT'
QuestScript101_14 = 'ITS GONNA KILL US ALLLLLLLLLLLLLLLLLLLLLLLL'
QuestScript110_1 = 'hey bud. heres your passport.'
QuestScript110_2 = 'this very powerful tool will give you the ultimate power.'
QuestScript110_3 = "Open it, and I'll show you."
QuestScript110_4 = "The map shows how dumb you are."
QuestScript110_5 = 'Turn the page to see your gags...'
QuestScript110_6 = 'OH CRAP I FORGOT'
QuestScript110_7 = 'CLICK AWAY'
QuestScript110_8 = 'so uh anyways, trolley time.'
QuestScript110_9 = 'trolley is somewhere out there, im too lazy to tell you where it is.'
QuestScript110_10 = 'can you get the book off your face now?'
QuestScript110_11 = 'when your done just do something now go away youre making my teeth rot'
QuestScriptTutorialBlocker_1 = 'Hello there! I\'m %s, and I run Toon Headquarters!' % Flippy
QuestScriptTutorialBlocker_2 = 'Welcome to Toontown! You\'re going to have an amazing adventure here!'
QuestScriptTutorialBlocker_3 = "I see Mickey's been showing you around - that's great! He's the best guide around!"
QuestScriptTutorialBlocker_4 = 'Once you finish the tutorial, come see me at Toon HQ for your first ToonTask!'
QuestScriptTutorialBlocker_5 = 'ToonTasks are quests that help you explore Toontown and fight the Cogs! They\'re super fun and rewarding!'
QuestScriptTutorialBlocker_6 = "I'll be waiting for you at Toon Hall - you can't miss it! It's the big building with all the flags!"
QuestScriptTutorialBlocker_7 = "Good luck with the tutorial! You're going to do great!"
QuestScriptTutorialBlocker_8 = 'See you soon! Have fun and remember - laughter is your best weapon!'
QuestScriptGagShop_1 = 'Welcome to Goofy\'s Gag Shop! *spins around excitedly* This is where Toons come to buy gags to use against the Cogs!'
QuestScriptGagShop_1a = 'Gags are your weapons in battle! From pies to pianos, we\'ve got everything you need to make those Cogs laugh!'
QuestScriptGagShop_3 = 'To buy gags, just click on the gag buttons you want! Try buying some now - start with the Throw gags!'
QuestScriptGagShop_4 = 'Excellent! You can use these gags in battle against the Cogs! The more gags you have, the stronger you become!'
QuestScriptGagShop_5 = "Here's a peek at the advanced gags - they do WAY more damage! But you'll need to earn them by using your gags in battle!"
QuestScriptGagShop_6 = "When you're done buying gags, you're all set! Remember - you can always come back to buy more!"
QuestScriptGagShop_7 = 'Pro tip: In singleplayer mode, you can use the FREE restock button anytime to refill your gags instantly!'
QuestScriptGagShop_8 = "Alright, you're all set! Go out there and show those Cogs what you're made of!"
