...
class TTChatInputNormal(ChatInputNormal.ChatInputNormal):
    ...
    def __init__(self, chatMgr):
        ...
        baseChatFrameXPos = -1.083
        chatFrameXPos = base.getWidescreenXOffset(baseChatFrameXPos, 'left') if hasattr(base, 'getWidescreenXOffset') else baseChatFrameXPos
        self.chatFrame = DirectFrame(parent=aspect2dp, image=gui.find('**/Chat_Bx_FNL'), relief=None, pos=(chatFrameXPos, 0, 0.804), state=DGG.NORMAL, sortOrder=DGG.FOREGROUND_SORT_INDEX)
        self.chatFrame.hide()
